 ...
 */
+ (id)cellWithText:(NSString *)cellText textAlignment:(NSTextAlignment)textAlignment;
 ...
 *  @param textAlignment The alignment setting for the cell's text.
 */
- (id)initWithText:(NSString *)cellText textAlignment:(NSTextAlignment)textAlignment;
...
+ (id)cellWithCell:(UITableViewCell *)cell;
